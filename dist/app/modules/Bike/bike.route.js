...
router.post('/', (0, validRequest_1.validRequest)(bike_validation_1.bikeSchema), bike_controller_1.bikeController.bikeCreate);
router.get('/', bike_controller_1.bikeController.getAllBikes);
router.get('/:bikeId', bike_controller_1.bikeController.getSingleBike);
router.patch('/:bikeId', (0, validRequest_1.validRequest)(bike_validation_1.updateBikeSchema), bike_controller_1.bikeController.updateBike);
